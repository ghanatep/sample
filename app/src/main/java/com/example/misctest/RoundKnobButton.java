...
public class RoundKnobButton extends RelativeLayout implements OnGestureListener {
    ...
    public void setRotorPosAngle(float deg) {
        Log.d("RoundKnobButton: Ang", "deg: " + deg);
        if (deg >= 210 || deg <= 150) {
    ...
    public void setRotorPercentage(int percentage) {
        Log.d("RoundKnobButton: Per", "percentage: " + percentage);
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        Log.d("RoundKnobButton: onScro", "x: " + x + ", y: " + y);
        Log.d("RoundKnobButton: onScro", "rotDegrees: " + rotDegrees);
        ...
        if (!Float.isNaN(rotDegrees)) {
            ...
            if (posDegrees > 210 || posDegrees < 150) {
                ...
                // get a linear scale
                float scaleDegrees = rotDegrees + 300; // given the current parameters, we go from 0 to 300
                // get position percent
                int percent = (int) (scaleDegrees / 6);
